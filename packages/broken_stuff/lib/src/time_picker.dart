...
import '../../../alternative_material_3/lib/src/curves.dart';
...
import '../../../alternative_material_3/lib/src/feedback.dart';
import '../../../alternative_material_3/lib/src/icons.dart';
import '../../../alternative_material_3/lib/src/ink_well.dart';
import '../../../alternative_material_3/lib/src/text_field/input_border.dart';
import '../../../alternative_material_3/lib/src/text_field/input_decorator.dart';
...
import '../../../alternative_material_3/lib/src/text_field/text_field_theme.dart';
import '../../../alternative_material_3/lib/src/text_form_field.dart';
...
import '../../../alternative_material_3/lib/src/time.dart';
import '../../../alternative_material_3/lib/src/time_picker_theme.dart';
    ...
    switch (_TimePickerModel.orientationOf(context)) {
      case Orientation.portrait:
        return Column(
          ...
          children: <Widget>[
            Padding(padding: const EdgeInsetsDirectional.only(bottom: 20),
              child: Text(
                helpText,
...
class _HourMinuteTextFieldState extends State<_HourMinuteTextField> with RestorationMixin {
  ...
  Widget build(BuildContext context) {
    ...
    //fixme
    // final InputDecorationTheme inputDecorationTheme = timePickerTheme.textFieldTheme ?? defaultTheme.textFieldTheme;
    final TextFieldThemeData inputDecorationTheme = TextFieldTheme
        .resolve(context, TextFieldStyle.outlined);
    ...
    final Color startingFillColor =
      timePickerTheme.textFieldTheme?.containerColor.resolve({}) ??
        ...
        child: UnmanagedRestorationScope(
          ...
          child: Semantics(
            ...
            child: TextFormField(
              ...
              onSubmitted: widget.onSavedSubmitted,
...
class _TimePickerState extends State<_TimePicker> with RestorationMixin {
  ...
  Widget build(BuildContext context) {
    ...
    switch (widget.entryMode) {
      ...
      case TimePickerEntryMode.input:
      case TimePickerEntryMode.inputOnly:
        final String helpText =  widget.helpText ?? localizations.timePickerInputHelpText;
...
abstract class _TimePickerDefaults extends TimePickerThemeData {
  ...
  @override
  TextFieldThemeData get textFieldTheme;
