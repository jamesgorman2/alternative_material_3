...
import '../../../alternative_material_3/lib/src/app_bar_theme.dart';
        ...
        child: Scaffold(
          appBar: AppBar(
            ...
            title: TextField(
              ...
              focusNode: focusNode,
              textStyle: widget.delegate.searchFieldStyle ?? theme.textTheme.titleLarge,
              textInputAction: widget.delegate.textInputAction,
              keyboardType: widget.delegate.keyboardType,
              onSubmitted: (String _) {
                widget.delegate.showResults(context);
              },
              decoration: InputDecoration(placeholderText: searchFieldLabel),
            ),
