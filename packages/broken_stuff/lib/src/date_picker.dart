...
import '../../../alternative_material_3/lib/src/action_buttons.dart' show CloseButton;
import '../../../alternative_material_3/lib/src/app_bar.dart';
...
import '../../../alternative_material_3/lib/src/calendar_date_picker.dart';
import '../../../alternative_material_3/lib/src/color_scheme.dart';
import '../../../alternative_material_3/lib/src/colors.dart';
import '../../../alternative_material_3/lib/src/date.dart';
import '../../../alternative_material_3/lib/src/date_picker_theme.dart';
...
import '../../../alternative_material_3/lib/src/text_field/text_field.dart';
  ...
  Size _dialogSize(BuildContext context) {
    ...
    switch (_entryMode.value) {
      ...
      case DatePickerEntryMode.calendarOnly:
        switch (orientation) {
          case Orientation.portrait:
            return _calendarPortraitDialogSizeM3;
      ...
      case DatePickerEntryMode.inputOnly:
        switch (orientation) {
          case Orientation.portrait:
            return _inputPortraitDialogSizeM3;
          case Orientation.landscape:
        ...
        Expanded(
          child: TextField(
            ...
            decoration: InputDecoration(
              placeholderText: widget.fieldStartHintText ?? localizations.dateHelpText,
              label: Text(widget.fieldStartLabelText ?? localizations.dateRangeStartLabel),
        ...
        Expanded(
          child: TextField(
            ...
            decoration: InputDecoration(
              ...
              placeholderText: widget.fieldEndHintText ?? localizations.dateHelpText,
              label: Text(widget.fieldEndLabelText ?? localizations.dateRangeEndLabel),
