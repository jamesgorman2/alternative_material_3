...
/// [VerticalCaretMovementRunM3.current]) to the previous line, and in case
...
/// the [VerticalCaretMovementRunM3] must not be used. The [isValid] property must
/// be checked before calling [movePrevious], [moveNext] and [moveByOffset],
/// or accessing [current].
class VerticalCaretMovementRunM3 implements Iterator<TextPosition> {
  VerticalCaretMovementRunM3._(
      this._editable,
      this._lineMetrics,
  ...
  final RenderEditableM3 _editable;

  bool _isValid = true;
  /// Whether this [VerticalCaretMovementRunM3] can still continue.
  ///
  /// A [VerticalCaretMovementRunM3] run is valid if the underlying text layout
  /// hasn't changed.
  ///
...
class RenderEditableM3 extends RenderBox with RelayoutWhenSystemFontsChangeMixin, ContainerRenderObjectMixin<RenderBox, TextParentData>, RenderBoxContainerDefaultsMixin<RenderBox, TextParentData> implements TextLayoutMetrics {
  ...
  RenderEditableM3({
    ...
    RenderEditableM3Painter? painter,
    RenderEditableM3Painter? foregroundPainter,
  ...
  _RenderEditableM3CustomPaint? _foregroundRenderObject;
  _RenderEditableM3CustomPaint? _backgroundRenderObject;
  ...
  void _updateForegroundPainter(RenderEditableM3Painter? newPainter) {
    final _CompositeRenderEditableM3Painter effectivePainter = newPainter == null
        ? _builtInForegroundPainters
        : _CompositeRenderEditableM3Painter(painters: <RenderEditableM3Painter>[
      _builtInForegroundPainters,
      newPainter,
    ]);

    if (_foregroundRenderObject == null) {
      final _RenderEditableM3CustomPaint foregroundRenderObject = _RenderEditableM3CustomPaint(painter: effectivePainter);
  ...
  /// The [RenderEditableM3Painter] to use for painting above this
  /// [RenderEditableM3]'s text content.
  ///
  /// The new [RenderEditableM3Painter] will replace the previously specified
  /// foreground painter, and schedule a repaint if the new painter's
  /// `shouldRepaint` method returns true.
  RenderEditableM3Painter? get foregroundPainter => _foregroundPainter;
  RenderEditableM3Painter? _foregroundPainter;
  set foregroundPainter(RenderEditableM3Painter? newPainter) {
  ...
  void _updatePainter(RenderEditableM3Painter? newPainter) {
    final _CompositeRenderEditableM3Painter effectivePainter = newPainter == null
        ? _builtInPainters
        : _CompositeRenderEditableM3Painter(painters: <RenderEditableM3Painter>[_builtInPainters, newPainter]);

    if (_backgroundRenderObject == null) {
      final _RenderEditableM3CustomPaint backgroundRenderObject = _RenderEditableM3CustomPaint(painter: effectivePainter);
  ...
  /// Sets the [RenderEditableM3Painter] to use for painting beneath this
  /// [RenderEditableM3]'s text content.
  ///
  /// The new [RenderEditableM3Painter] will replace the previously specified
  /// painter, and schedule a repaint if the new painter's `shouldRepaint`
  /// method returns true.
  RenderEditableM3Painter? get painter => _painter;
  RenderEditableM3Painter? _painter;
  set painter(RenderEditableM3Painter? newPainter) {
  ...
  _CompositeRenderEditableM3Painter get _builtInForegroundPainters => _cachedBuiltInForegroundPainters ??= _createBuiltInForegroundPainters();
  _CompositeRenderEditableM3Painter? _cachedBuiltInForegroundPainters;
  _CompositeRenderEditableM3Painter _createBuiltInForegroundPainters() {
    return _CompositeRenderEditableM3Painter(
      painters: <RenderEditableM3Painter>[
        if (paintCursorAboveText) _caretPainter,
      ],
    );
  }

  _CompositeRenderEditableM3Painter get _builtInPainters => _cachedBuiltInPainters ??= _createBuiltInPainters();
  _CompositeRenderEditableM3Painter? _cachedBuiltInPainters;
  _CompositeRenderEditableM3Painter _createBuiltInPainters() {
    return _CompositeRenderEditableM3Painter(
      painters: <RenderEditableM3Painter>[
  ...
  // non-null value in the RenderEditableM3 constructor and we refuse to
  ...
  /// {@template flutter.rendering.RenderEditableM3.paintCursorAboveText}
  ...
  /// {@template flutter.rendering.RenderEditableM3.cursorOffset}
  ...
  ///
  /// [RenderEditableM3] is responsible for calculating the [Offset] of this
  ...
  ///
  /// Since [RenderEditableM3] does not handle selection manipulation
  ...
  Rect getLocalRectForCaret(TextPosition caretPosition) {
    ...
    final inputBaseline = _textPainter.computeDistanceToActualBaseline(TextBaseline.alphabetic);
    ...
    // With StrutStyle.disabled getOffsetForCaret is aligning to baseline
    final double caretY = math.max(caretRect.top - inputBaseline, 0.0);
    caretRect = Offset(caretX, caretY) & caretRect.size;

    final double caretHeight = cursorHeight;
    switch (defaultTargetPlatform) {
      case TargetPlatform.iOS:
      case TargetPlatform.macOS:
        final painterHeightForCaret = _textPainter.getFullHeightForCaret(caretPosition, caretPrototype);
        final double fullHeight = painterHeightForCaret == null || painterHeightForCaret == 0.0
            ? _textPainter.preferredLineHeight
            : painterHeightForCaret;
  ...
  /// {@template flutter.rendering.RenderEditableM3.lastSecondaryTapDownPosition}
  ...
  ///
  /// {@template flutter.rendering.RenderEditableM3.selectPosition}
  ...
  ///
  /// {@macro flutter.rendering.RenderEditableM3.selectPosition}
  ...
  // as dirty.
  //
  // This method must be called in `RenderEditableM3`'s public methods that expose
  ...
  // may crash.
  //
  // This method is also called in various paint methods (`RenderEditableM3.paint`
  ...
  /// Starts a [VerticalCaretMovementRunM3] at the given location in the text, for
  /// handling consecutive vertical caret movements.
  ///
  /// This can be used to handle consecutive upward/downward arrow key movements
  /// in an input field.
  ///
  /// {@macro flutter.rendering.RenderEditableM3.verticalArrowKeyMovement}
  ///
  /// The [VerticalCaretMovementRunM3.isValid] property indicates whether the text
  /// layout has changed and the vertical caret run is invalidated.
  ///
  /// The caller should typically discard a [VerticalCaretMovementRunM3] when
  /// its [VerticalCaretMovementRunM3.isValid] becomes false, or on other
  /// occasions where the vertical caret run should be interrupted.
  VerticalCaretMovementRunM3 startVerticalCaretMovement(TextPosition startPosition) {
    ...
    return VerticalCaretMovementRunM3._(
      this,
      metrics,
      startPosition,
      currentLine.key,
...
class _RenderEditableM3CustomPaint extends RenderBox {
  _RenderEditableM3CustomPaint({
    RenderEditableM3Painter? painter,
  }) : _painter = painter,
        super();

  @override
  RenderEditableM3? get parent => super.parent as RenderEditableM3?;
  ...
  RenderEditableM3Painter? get painter => _painter;
  RenderEditableM3Painter? _painter;
  set painter(RenderEditableM3Painter? newValue) {
    if (newValue == painter) {
      return;
    }

    final RenderEditableM3Painter? oldPainter = painter;
    _painter = newValue;
  ...
  @override
  void paint(PaintingContext context, Offset offset) {
    final RenderEditableM3? parent = this.parent;
    assert(parent != null);
    final RenderEditableM3Painter? painter = this.painter;
...
/// An interface that paints within a [RenderEditableM3]'s bounds, above or
...
/// blocks). It can paint independently from its [RenderEditableM3], allowing it
/// to repaint without triggering a repaint on the entire [RenderEditableM3] stack
/// when only auxiliary content changes (e.g. a blinking cursor) are present. It
/// will be scheduled to repaint when:
///
///  * It's assigned to a new [RenderEditableM3] and the [shouldRepaint] method
///    returns true.
///  * Any of the [RenderEditableM3]s it is attached to repaints.
///  * The [notifyListeners] method is called, which typically happens when the
///    painter's attributes change.
///
/// See also:
///
///  * [RenderEditableM3.foregroundPainter], which takes a [RenderEditableM3Painter]
///    and sets it as the foreground painter of the [RenderEditableM3].
///  * [RenderEditableM3.painter], which takes a [RenderEditableM3Painter]
///    and sets it as the background painter of the [RenderEditableM3].
///  * [CustomPainter] a similar class which paints within a [RenderCustomPaint].
abstract class RenderEditableM3Painter extends ChangeNotifier {

  /// Determines whether repaint is needed when a new [RenderEditableM3Painter]
  /// is provided to a [RenderEditableM3].
  ///
  ...
  /// [RenderEditableM3]s it attaches to repaint, even if [shouldRepaint] returns
  /// false.
  bool shouldRepaint(RenderEditableM3Painter? oldDelegate);

  /// Paints within the bounds of a [RenderEditableM3].
  ///
  /// The given [Canvas] has the same coordinate space as the [RenderEditableM3],
  /// which may be different from the coordinate space the [RenderEditableM3]'s
  /// [TextPainter] uses, when the text moves inside the [RenderEditableM3].
  ///
  /// Paint operations performed outside of the region defined by the [canvas]'s
  /// origin and the [size] parameter may get clipped, when [RenderEditableM3]'s
  /// [RenderEditableM3.clipBehavior] is not [Clip.none].
  void paint(Canvas canvas, Size size, RenderEditableM3 renderEditable);
}

class _TextHighlightPainter extends RenderEditableM3Painter {
...
class _FloatingCursorPainter extends RenderEditableM3Painter {
  ...
  void paintRegularCursor(Canvas canvas, RenderEditableM3 renderEditable, Color caretColor, TextPosition textPosition) {
...
class _CompositeRenderEditableM3Painter extends RenderEditableM3Painter {
  _CompositeRenderEditableM3Painter({ required this.painters });

  final List<RenderEditableM3Painter> painters;

  @override
  void addListener(VoidCallback listener) {
    for (final RenderEditableM3Painter painter in painters) {
  ...
  bool shouldRepaint(RenderEditableM3Painter? oldDelegate) {
    ...
    if (oldDelegate is! _CompositeRenderEditableM3Painter || oldDelegate.painters.length != painters.length) {
      return true;
    }

    final Iterator<RenderEditableM3Painter> oldPainters = oldDelegate.painters.iterator;
    final Iterator<RenderEditableM3Painter> newPainters = painters.iterator;
