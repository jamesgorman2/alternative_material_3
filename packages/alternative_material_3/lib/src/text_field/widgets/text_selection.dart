...
class _SelectionToolbarWrapperState extends State<_SelectionToolbarWrapper> with SingleTickerProviderStateMixin {
  ...
  void initState() {
    ...
    _controller = AnimationController(duration: SelectionOverlayM3.fadeDuration, vsync: this);
...
/// [RenderEditable].
///
/// This class is a wrapper of [SelectionOverlayM3] to provide APIs specific for
/// [RenderEditable]s. To manage selection handles for custom widgets, use
/// [SelectionOverlayM3] instead.
class TextSelectionOverlayM3 {
  /// Creates an object that manages overlay entries for selection handles.
  ///
  /// The [context] must not be null and must have an [Overlay] as an ancestor.
  TextSelectionOverlayM3({
    ...
    required TextMagnifierConfiguration magnifierConfiguration,
        ...
        _value = value {
    renderObject.selectionStartInViewport.addListener(_updateTextSelectionOverlayM3Visibilities);
    renderObject.selectionEndInViewport.addListener(_updateTextSelectionOverlayM3Visibilities);
    _updateTextSelectionOverlayM3Visibilities();
    _selectionOverlay = SelectionOverlayM3(
  ...
  /// {@template flutter.widgets.SelectionOverlayM3.context}
  ...
  @Deprecated(
      'Use `SelectionOverlayM3.fadeDuration` instead. '
          'This feature was deprecated after v2.12.0-4.1.pre.'
  )
  static const Duration fadeDuration = SelectionOverlayM3.fadeDuration;

  // TODO(mpcomplete): what if the renderObject is removed or replaced, or
  // moves? Not sure what cases I need to handle, or how to handle them.
  /// The editable line in which the selected text is being displayed.
  final RenderEditableM3 renderObject;

  /// {@macro flutter.widgets.SelectionOverlayM3.selectionControls}
  final TextSelectionControls? selectionControls;

  /// {@macro flutter.widgets.SelectionOverlayM3.selectionDelegate}
  final TextSelectionDelegate selectionDelegate;

  late final SelectionOverlayM3 _selectionOverlay;
  ...
  void _updateTextSelectionOverlayM3Visibilities() {
  ...
  /// {@macro flutter.widgets.SelectionOverlayM3.showHandles}
  void showHandles() {
    _updateSelectionOverlayM3();
    _selectionOverlay.showHandles();
  }

  /// {@macro flutter.widgets.SelectionOverlayM3.hideHandles}
  void hideHandles() => _selectionOverlay.hideHandles();

  /// {@macro flutter.widgets.SelectionOverlayM3.showToolbar}
  void showToolbar() {
    _updateSelectionOverlayM3();
  ...
  /// {@macro flutter.widgets.SelectionOverlayM3.showMagnifier}
  ...
  /// {@macro flutter.widgets.SelectionOverlayM3.updateMagnifier}
  ...
  /// {@macro flutter.widgets.SelectionOverlayM3.hideMagnifier}
  void hideMagnifier() {
  ...
  void update(TextEditingValue newValue) {
    ...
    _value = newValue;
    _updateSelectionOverlayM3();
    // _updateSelectionOverlayM3 may not rebuild the selection overlay if the
  ...
  void _updateSelectionOverlayM3() {
    _selectionOverlay
  ...
  /// {@macro flutter.widgets.SelectionOverlayM3.hide}
  void hide() => _selectionOverlay.hide();

  /// {@macro flutter.widgets.SelectionOverlayM3.hideToolbar}
  void hideToolbar() => _selectionOverlay.hideToolbar();

  /// {@macro flutter.widgets.SelectionOverlayM3.dispose}
  void dispose() {
    _selectionOverlay.dispose();
    renderObject.selectionStartInViewport.removeListener(_updateTextSelectionOverlayM3Visibilities);
    renderObject.selectionEndInViewport.removeListener(_updateTextSelectionOverlayM3Visibilities);
  ...
  MagnifierInfo _buildMagnifier({
    required RenderEditableM3 renderEditable,
...
class SelectionOverlayM3 {
  ...
  /// {@macro flutter.widgets.SelectionOverlayM3.context}
  final BuildContext context;
  ...
  /// with other properties in [SelectionOverlayM3].
  ...
  ///
  /// By default, [SelectionOverlayM3]'s [TextMagnifierConfiguration] is disabled.
  ///
  ...
  /// {@template flutter.widgets.SelectionOverlayM3.showMagnifier}
  ...
  /// {@template flutter.widgets.SelectionOverlayM3.hideMagnifier}
  ...
  /// {@template flutter.widgets.SelectionOverlayM3.selectionControls}
  /// Builds text selection handles and toolbar.
  /// {@endtemplate}
  final TextSelectionControls? selectionControls;

  /// {@template flutter.widgets.SelectionOverlayM3.selectionDelegate}
  ...
  /// {@template flutter.widgets.SelectionOverlayM3.onSelectionHandleTapped}
  ...
  /// {@template flutter.widgets.SelectionOverlayM3.showHandles}
  ...
  /// {@template flutter.widgets.SelectionOverlayM3.hideHandles}
  ...
  /// {@template flutter.widgets.SelectionOverlayM3.showToolbar}
  ...
  /// {@template flutter.widgets.SelectionOverlayM3.hide}
  ...
  /// {@template flutter.widgets.SelectionOverlayM3.hideToolbar}
  ...
  /// {@template flutter.widgets.SelectionOverlayM3.dispose}
  ...
  /// {@template flutter.widgets.SelectionOverlayM3.updateMagnifier}
...
/// Delegate interface for the [TextSelectionGestureDetectorBuilderM3].
///
/// The interface is usually implemented by text field implementations wrapping
/// [EditableTextM3], that use a [TextSelectionGestureDetectorBuilderM3] to build a
/// [TextSelectionGestureDetector] for their [EditableTextM3]. The delegate provides
...
///    text field.
abstract class TextSelectionGestureDetectorBuilderM3Delegate {
  /// [GlobalKey] to the [EditableTextM3] for which the
  /// [TextSelectionGestureDetectorBuilderM3] will build a [TextSelectionGestureDetector].
  GlobalKey<EditableTextM3State> get editableTextKey;
...
/// Builds a [TextSelectionGestureDetector] to wrap an [EditableTextM3].
///
/// The class implements sensible defaults for many user interactions
/// with an [EditableTextM3] (see the documentation of the various gesture handler
/// methods, e.g. [onTapDown], [onForcePressStart], etc.). Subclasses of
/// [TextSelectionGestureDetectorBuilderM3] can change the behavior performed in
/// responds to these gesture events by overriding the corresponding handler
/// methods of this class.
///
/// The resulting [TextSelectionGestureDetector] to wrap an [EditableTextM3] is
/// obtained by calling [buildGestureDetector].
///
/// See also:
///
///  * [TextField], which uses a subclass to implement the Material-specific
///    gesture logic of an [EditableTextM3].
///  * [CupertinoTextField], which uses a subclass to implement the
///    Cupertino-specific gesture logic of an [EditableTextM3].
class TextSelectionGestureDetectorBuilderM3 {
  /// Creates a [TextSelectionGestureDetectorBuilderM3].
  ///
  /// The [delegate] must not be null.
  TextSelectionGestureDetectorBuilderM3({
    required this.delegate,
  });

  /// The delegate for this [TextSelectionGestureDetectorBuilderM3].
  ///
  /// The delegate provides the builder with information about what actions can
  /// currently be performed on the text field. Based on this, the builder adds
  /// the correct gesture handlers to the gesture detector.
  @protected
  final TextSelectionGestureDetectorBuilderM3Delegate delegate;
  ...
  /// The [State] of the [EditableTextM3] for which the builder will provide a
  /// [TextSelectionGestureDetector].
  @protected
  EditableTextM3State get editableText => delegate.editableTextKey.currentState!;

  /// The [RenderObject] of the [EditableTextM3] for which the builder will
  /// provide a [TextSelectionGestureDetector].
  @protected
  RenderEditableM3 get renderEditable => editableText.renderEditable;
  ...
  /// [TextSelectionGestureDetectorBuilderM3Delegate.selectionEnabled] is true
  ...
  ///
  /// The [child] or its subtree should contain [EditableTextM3].
