...
import 'package:flutter/widgets.dart' show immutable, SpellCheckConfiguration;

import 'editable_text.dart' show EditableTextContextMenuBuilderM3;
import 'proxies.dart';
...
class SpellCheckConfigurationM3 {
  ...
  /// words.
  final EditableTextContextMenuBuilderM3? spellCheckSuggestionsToolbarBuilder;
  ...
  /// Returns a copy of the current [SpellCheckConfigurationM3] instance with
  /// specified overrides.
  SpellCheckConfigurationM3 copyWith(
    ...
    return SpellCheckConfigurationM3(
  ...
  misspelled selection color : $misspelledSelectionColor
...
'''
  ...
  bool operator ==(Object other) {
    ...
    return other is SpellCheckConfigurationM3 &&
