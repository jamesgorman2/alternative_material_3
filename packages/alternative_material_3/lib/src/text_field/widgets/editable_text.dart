...
typedef SelectionChangedCallbackM3 = void Function(TextSelection selection, SelectionChangedCause? cause);
...
///    [SelectableRegion].
typedef EditableTextContextMenuBuilderM3 = Widget Function(
...
class EditableTextM3 extends StatefulWidget {
  ...
  ///
  /// The cursor refers to the blinking caret when the [EditableTextM3] is focused.
  /// {@endtemplate}
  ///
  /// See also:
  ///
  ...
  /// [CupertinoTextField], and [EditableTextM3].
  ///
  ...
  ///
  /// The [EditableTextM3] widget used on its own will not trigger the display
  /// of the selection toolbar by itself. The toolbar is shown by calling
  /// [EditableTextM3State.showToolbar] in response to an appropriate user event.
  ///
  /// See also:
  ///
  ///  * [CupertinoTextField], which wraps an [EditableTextM3] and which shows the
  ///    selection toolbar upon user events that are appropriate on the iOS
  ///    platform.
  ///  * [TextField], a Material Design themed wrapper of [EditableTextM3], which
  ...
  /// location).
  /// {@endtemplate}
  final SelectionChangedCallbackM3? onSelectionChanged;
  ...
  ///
  /// The [mouseCursor] is the only property of [EditableTextM3] that controls the
  ...
  ///
  /// When null, this widget's [EditableTextM3State] will be used as the
  ...
  /// [EditableTextM3].
  ///
  /// If a restoration id is provided, the [EditableTextM3] will persist its
  /// current scroll offset and restore it during state restoration.
  ///
  /// The scroll offset is persisted in a [RestorationBucket] claimed from
  /// the surrounding [RestorationScope] using the provided restoration ID.
  ///
  /// Persisting and restoring the content of the [EditableTextM3] is the
  ...
  /// {@endtemplate}
  final SpellCheckConfigurationM3? spellCheckConfiguration;
  ...
  ///
  /// For example, [EditableTextM3] uses this to generate the default buttons for
  /// its context menu.
  ///
  /// See also:
  ///
  /// * [EditableTextM3State.contextMenuButtonItems], which gives the
  ...
  @override
  EditableTextM3State createState() => EditableTextM3State();
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties.add(DiagnosticsProperty<SpellCheckConfigurationM3>('spellCheckConfiguration', spellCheckConfiguration, defaultValue: null));
...
/// State for a [EditableTextM3].
class EditableTextM3State extends State<EditableTextM3> with AutomaticKeepAliveClientMixin<EditableTextM3>, WidgetsBindingObserver, TickerProviderStateMixin<EditableTextM3>, TextSelectionDelegate, TextInputClient implements AutofillClient {
  Timer? _cursorTimer;
  ...
  TextSelectionOverlayM3? _selectionOverlay;
  ...
  late SpellCheckConfigurationM3 _spellCheckConfiguration;
  ...
  @visibleForTesting
  SpellCheckConfigurationM3 get spellCheckConfiguration => _spellCheckConfiguration;

  /// Whether or not spell check is enabled.
  ///
  /// Spell check is enabled when a [SpellCheckConfigurationM3] has been specified
  /// for the widget.
  ...
  /// Infers the [SpellCheckConfigurationM3] used to perform spell check.
  ///
  /// If spell check is enabled, this will try to infer a value for
  /// the [SpellCheckService] if left unspecified.
  static SpellCheckConfigurationM3 _inferSpellCheckConfiguration(SpellCheckConfigurationM3? configuration) {
    final SpellCheckService? spellCheckService = configuration?.spellCheckService;
    final bool spellCheckAutomaticallyDisabled = configuration == null || !configuration.spellCheckEnabled;
  ...
  /// Returns the [ContextMenuButtonItem]s representing the buttons in this
  /// platform's default selection menu for [EditableTextM3].
  ///
  /// See also:
  ///
  /// * [EditableTextM3.getEditableButtonItems], which performs a similar role,
  ...
  List<ContextMenuButtonItem> get contextMenuButtonItems {
    return buttonItemsForToolbarOptions() ?? EditableTextM3.getEditableButtonItems(
  ...
  @override
  void didUpdateWidget(EditableTextM3 oldWidget) {
  ...
  /// update via [updateEditingValue], or when [EditableTextM3] calls
  ...
  ///
  /// Throws an error in debug mode if this [EditableTextM3] is not in a batch
  /// edit.
  void endBatchEdit() {
    _batchEditDepth -= 1;
    assert(
  ...
  TextSelectionOverlayM3 _createSelectionOverlay() {
    final TextSelectionOverlayM3 selectionOverlay = TextSelectionOverlayM3(
  ...
  @visibleForTesting
  TextSelectionOverlayM3? get selectionOverlay => _selectionOverlay;
  ...
  void _startCursorBlink() {
    ...
    _cursorTimer?.cancel();
    _cursorBlinkOpacityController.value = 1.0;
    if (EditableTextM3.debugDeterministicCursor) {
      return;
    }
  ...
  late final RenderEditableM3 renderEditable = _editableKey.currentContext!.findRenderObject()! as RenderEditableM3;
  ...
  void toggleToolbar([bool hideHandles = true]) {
    final TextSelectionOverlayM3 selectionOverlay = _selectionOverlay ??= _createSelectionOverlay();
                      ...
                      child: Semantics(
                        ...
                        child: _ScribbleFocusable(
                          ...
                          child: _Editable(
                            ...
                            showCursor: EditableTextM3.debugDeterministicCursor
...
class _Editable extends MultiChildRenderObjectWidget {
  ...
  @override
  RenderEditableM3 createRenderObject(BuildContext context) {
    return RenderEditableM3(
      text: inlineSpan,
  ...
  @override
  void updateRenderObject(BuildContext context, RenderEditableM3 renderObject) {
    renderObject
      ..text = inlineSpan
      ..cursorColor = cursorColor
      ..startHandleLayerLink = startHandleLayerLink
...
/// e.g. password input in [EditableTextM3]. If you are handling text that may
...
class _DeleteTextAction<T extends DirectionalTextEditingIntent> extends ContextAction<T> {
  ...
  final EditableTextM3State state;
...
class _UpdateTextSelectionVerticallyAction<T extends DirectionalCaretMovementIntent> extends ContextAction<T> {
  ...
  VerticalCaretMovementRunM3? _verticalMovementRun;
  ...
  void invoke(T intent, [BuildContext? context]) {
    ...
    final VerticalCaretMovementRunM3 currentRun = _verticalMovementRun
