...
void main() {
  ...
  final ThemeData material3Theme = ThemeData.light().copyWith();
  ...
  testWidgets('FloatingActionButton.extended can customize text style', (WidgetTester tester) async {
    ...
    expect(rawMaterialButton.textStyle, style.copyWith(color: ColorScheme.m3DefaultLight.onPrimaryContainer));
  });
