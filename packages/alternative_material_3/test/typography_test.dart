...
void main() {
  ...
  test('Typography on non-Apple platforms defaults to the correct font', () {
    expect(Typography.material2021().black.titleLarge.fontFamily, 'Roboto');
    expect(Typography.material2021(platform: TargetPlatform.fuchsia).black.titleLarge.fontFamily, 'Roboto');
    expect(Typography.material2021(platform: TargetPlatform.linux).black.titleLarge.fontFamily, 'Roboto');
    expect(Typography.material2021(platform: TargetPlatform.linux).black.titleLarge.fontFamilyFallback, <String>['Ubuntu', 'Cantarell', 'DejaVu Sans', 'Liberation Sans', 'Arial']);
    expect(Typography.material2021(platform: TargetPlatform.windows).black.titleLarge.fontFamily, 'Segoe UI');
    expect(Typography.material2021().white.titleLarge.fontFamily, 'Roboto');
    expect(Typography.material2021(platform: TargetPlatform.fuchsia).white.titleLarge.fontFamily, 'Roboto');
    expect(Typography.material2021(platform: TargetPlatform.linux).white.titleLarge.fontFamily, 'Roboto');
    expect(Typography.material2021(platform: TargetPlatform.linux).white.titleLarge.fontFamilyFallback, <String>['Ubuntu', 'Cantarell', 'DejaVu Sans', 'Liberation Sans', 'Arial']);
    expect(Typography.material2021(platform: TargetPlatform.windows).white.titleLarge.fontFamily, 'Segoe UI');
  });
  ...
  test('Typography on iOS defaults to the correct SF font family based on size', () {
    final Typography typography = Typography.material2021(platform: TargetPlatform.iOS);
  ...
  test('Typography on macOS defaults to the system UI meta-font', () {
    final Typography typography = Typography.material2021(platform: TargetPlatform.macOS);
    for (final TextTheme textTheme in <TextTheme>[typography.black, typography.white]) {
  ...
  testWidgets('Typography implements debugFillProperties', (WidgetTester tester) async {
    ...
    Typography.material2021(
      ...
      englishLike: Typography.whiteCupertino,
      dense: Typography.whiteCupertino,
      tall: Typography.whiteCupertino,
