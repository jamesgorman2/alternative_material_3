...
void main() {
  ...
  testWidgets('Chip in row works ok', (WidgetTester tester) async {
    ...
    // fixme - probaly m2->m3
    expect(tester.getSize(find.byType(Text)), const Size(41.0, 14.0));
    expect(tester.getSize(find.byType(Chip)), const Size(75.0, 48.0));
    await tester.pumpWidget(
      wrapForChip(
        child: const Row(
          children: <Widget>[
  ...
  testWidgets('Chip responds to materialTapTargetSize', (WidgetTester tester) async {
      ...
      // fixme
      expect(tester.getSize(find.byType(Chip).first), const Size(49.0, 48.0));
      expect(tester.getSize(find.byType(Chip).last), const Size(49.0, 38.0));
    },
  );
  ...
  testWidgets('Chip responds to textScaleFactor', (WidgetTester tester) async {
    ...
    expect(
      ...
      const Size(85.0, 20.0),
    );
    expect(
      tester.getSize(find.text('Chip B')),
      const Size(85.0, 20.0),
    );
    expect(tester.getSize(find.byType(Chip).first), const Size(139.0, 48.0));
    expect(tester.getSize(find.byType(Chip).last), const Size(139.0, 48.0));
    ...
    expect(tester.getSize(find.text('Chip A')), const Size(253.0, 60.0));
    expect(tester.getSize(find.text('Chip B')), const Size(253.0, 60.0));
    expect(tester.getSize(find.byType(Chip).first), const Size(339.0, 78.0));
    expect(tester.getSize(find.byType(Chip).last), const Size(339.0, 78.0));
    ...
    expect(tester.getSize(find.text('Chip A')), const Size(253.0, 60.0));
    expect(tester.getSize(find.text('Chip B')), const Size(85.0, 20.0));
    expect(tester.getSize(find.byType(Chip).first), const Size(347.0, 78.0));
    expect(tester.getSize(find.byType(Chip).last), const Size(139.0, 48.0));
  });
  ...
  testWidgets('Labels can be non-text widgets', (WidgetTester tester) async {
    ...
    expect(tester.getSize(find.byKey(keyA)), const Size(85.0, 20.0));
  ...
  testWidgets('Avatar drawer works as expected on RawChip', (WidgetTester tester) async {
    ...
    // No avatar
    await pushChip();
    expect(tester.getSize(find.byType(Chip)), equals(const Size(80.0, 48.0)));
    ...
    expect(tester.getSize(find.byType(Chip)).width, moreOrLessEquals(81.2, epsilon: 0.1));
    expect(tester.getSize(find.byKey(avatarKey)), equals(const Size(24.0, 24.0)));
    ...
    await tester.pump(const Duration(milliseconds: 20));
    expect(tester.getSize(find.byType(Chip)).width, moreOrLessEquals(86.7, epsilon: 0.1));
    expect(tester.getSize(find.byKey(avatarKey)), equals(const Size(24.0, 24.0)));
    ...
    await tester.pump(const Duration(milliseconds: 20));
    expect(tester.getSize(find.byType(Chip)).width, moreOrLessEquals(94.7, epsilon: 0.1));
    expect(tester.getSize(find.byKey(avatarKey)), equals(const Size(24.0, 24.0)));
    ...
    await tester.pump(const Duration(milliseconds: 20));
    expect(tester.getSize(find.byType(Chip)).width, moreOrLessEquals(99.5, epsilon: 0.1));
    expect(tester.getSize(find.byKey(avatarKey)), equals(const Size(24.0, 24.0)));
    ...
    expect(tester.getSize(find.byType(Chip)), equals(const Size(104.0, 48.0)));
    expect(tester.getSize(find.byKey(avatarKey)), equals(const Size(24.0, 24.0)));
    ...
    expect(tester.getSize(find.byType(Chip)).width, moreOrLessEquals(102.9, epsilon: 0.1));
    expect(tester.getSize(find.byKey(avatarKey)), equals(const Size(24.0, 24.0)));
    ...
    await tester.pump(const Duration(milliseconds: 20));
    expect(tester.getSize(find.byType(Chip)).width, moreOrLessEquals(98.0, epsilon: 0.1));
    expect(tester.getSize(find.byKey(avatarKey)), equals(const Size(24.0, 24.0)));
    ...
    await tester.pump(const Duration(milliseconds: 20));
    expect(tester.getSize(find.byType(Chip)).width, moreOrLessEquals(84.1, epsilon: 0.1));
    expect(tester.getSize(find.byKey(avatarKey)), equals(const Size(24.0, 24.0)));
    ...
    await tester.pump(const Duration(milliseconds: 20));
    expect(tester.getSize(find.byType(Chip)).width, moreOrLessEquals(80.0, epsilon: 0.1));
    expect(tester.getSize(find.byKey(avatarKey)), equals(const Size(24.0, 24.0)));
  ...
  testWidgets('Delete button drawer works as expected on RawChip', (WidgetTester tester) async {
    ...
    expect(tester.getSize(find.byType(Chip)).width, moreOrLessEquals(103.8, epsilon: 0.1));
    expect(tester.getSize(find.byKey(deleteButtonKey)), equals(const Size(24.0, 24.0)));
    ...
    await tester.pump(const Duration(milliseconds: 20));
    expect(tester.getSize(find.byType(Chip)).width, moreOrLessEquals(101.0, epsilon: 0.1));
    expect(tester.getSize(find.byKey(deleteButtonKey)), equals(const Size(24.0, 24.0)));
    expect(tester.getTopLeft(find.byKey(deleteButtonKey)).dx, moreOrLessEquals(73.0, epsilon: 0.1));

    await tester.pump(const Duration(milliseconds: 20));
    expect(tester.getSize(find.byType(Chip)).width, moreOrLessEquals(97.5, epsilon: 0.1));
    expect(tester.getSize(find.byKey(deleteButtonKey)), equals(const Size(24.0, 24.0)));
  ...
  testWidgets('Selection with avatar works as expected on RawChip', (WidgetTester tester) async {
    ...
    // FIXME
    expect(tester.getSize(find.byType(Chip)), equals(const Size(266.0, 48.0)));
  ...
  testWidgets('Selection without avatar works as expected on RawChip', (WidgetTester tester) async {
    ...
    await pushChip();
    // FIXME
    expect(tester.getSize(find.byType(Chip)), equals(const Size(246.0, 48.0)));
  ...
  testWidgets('Chip size is configurable by ThemeData.materialTapTargetSize', (WidgetTester tester) async {
    ...
    // FIXME
    expect(tester.getSize(find.byKey(key1)), const Size(91.0, 48.0));
    ...
    // FIXME
    expect(tester.getSize(find.byKey(key2)), const Size(91.0, 38.0));
  });
  ...
  testWidgets('Chip uses stateful border side color in different states', (WidgetTester tester) async {
    ...
    chipFocusNode.requestFocus();
    await tester.pumpAndSettle();
    expect(find.byType(Chip), paints..rrect()..rrect(color: focusedColor));
    ...
    await gesture.moveTo(center);
    await tester.pumpAndSettle();
    expect(find.byType(Chip), paints..rrect()..rrect(color: hoverColor));

    // Pressed.
    await gesture.down(center);
    await tester.pumpAndSettle();
    expect(find.byType(Chip), paints..rrect()..rrect(color: pressedColor));

    // Disabled.
    await tester.pumpWidget(chipWidget(enabled: false));
    await tester.pumpAndSettle();
    expect(find.byType(Chip), paints..rrect()..rrect(color: disabledColor));
  }, skip: true);
  ...
  testWidgets('Chip uses stateful nullable border side color from resolveWith', (WidgetTester tester) async {
    ...
    // to the theme
    expect(find.byType(Chip), paints..rrect()..rrect(color: fallbackThemeColor));
  ...
  testWidgets('Chip defers to theme, if shape and side resolves to null', (WidgetTester tester) async {
    ...
    await tester.pumpWidget(chipWidget());
    expect(getMaterial(tester).shape, isA<StadiumBorder>());
    expect(find.byType(Chip), paints..rrect()..rrect(color: themeBorderSide.color));

    // Selected.
    await tester.pumpWidget(chipWidget(selected: true));
    expect(getMaterial(tester).shape, isA<RoundedRectangleBorder>());
    expect(find.byType(Chip), paints..rect()..drrect(color: selectedBorderSide.color));
  }, skip: true);
